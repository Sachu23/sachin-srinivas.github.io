(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactMotion = {}, global.React));
  ...
  var defaultNow = performanceNow.exports;
  ...
  */
    ...
    function Motion(props) {
      ...
      _this.startAnimationIfNecessary = function () {
        ...
        _this.animationID = defaultRaf(function (timestamp) {
          ...
          var currentFrameCompletion = (_this.accumulatedTime - Math.floor(_this.accumulatedTime / msPerFrame$2) * msPerFrame$2) / msPerFrame$2;
          ...
          for (var key in propsStyle) {
            ...
            if (typeof styleValue === 'number') {
              ...
              for (var i = 0; i < framesToCatchUp; i++) {
                var _stepper = stepper(msPerFrame$2 / 1000, newLastIdealStyleValue, newLastIdealVelocityValue, styleValue.val, styleValue.stiffness, styleValue.damping, styleValue.precision);

                newLastIdealStyleValue = _stepper[0];
                newLastIdealVelocityValue = _stepper[1];
              }

              var _stepper2 = stepper(msPerFrame$2 / 1000, newLastIdealStyleValue, newLastIdealVelocityValue, styleValue.val, styleValue.stiffness, styleValue.damping, styleValue.precision),
  ...
  function shouldStopAnimationAll$1(currentStyles, styles, currentVelocities) {
    ...
    function StaggeredMotion(props) {
      ...
      _this.startAnimationIfNecessary = function () {
        ...
        _this.animationID = defaultRaf(function (timestamp) {
          ...
          if (shouldStopAnimationAll$1(_this.state.currentStyles, destStyles, _this.state.currentVelocities)) {
            // no need to cancel animationID here; shouldn't have any in flight
            _this.animationID = null;
            _this.accumulatedTime = 0;
            return;
          ...
          var currentFrameCompletion = (_this.accumulatedTime - Math.floor(_this.accumulatedTime / msPerFrame$1) * msPerFrame$1) / msPerFrame$1;
            ...
            for (var key in destStyle) {
              ...
              if (typeof styleValue === 'number') {
                ...
                for (var j = 0; j < framesToCatchUp; j++) {
                  var _stepper = stepper(msPerFrame$1 / 1000, newLastIdealStyleValue, newLastIdealVelocityValue, styleValue.val, styleValue.stiffness, styleValue.damping, styleValue.precision);

                  newLastIdealStyleValue = _stepper[0];
                  newLastIdealVelocityValue = _stepper[1];
                }

                var _stepper2 = stepper(msPerFrame$1 / 1000, newLastIdealStyleValue, newLastIdealVelocityValue, styleValue.val, styleValue.stiffness, styleValue.damping, styleValue.precision),
                    nextIdealX = _stepper2[0],
                    nextIdealV = _stepper2[1];
  ...
  function shouldStopAnimationAll(currentStyles, destStyles, currentVelocities, mergedPropsStyles) {
    ...
    for (var _i = 0; _i < mergedPropsStyles.length; _i++) {
      if (!shouldStopAnimation(currentStyles[_i], destStyles[_i].style, currentVelocities[_i])) {
        return false;
      }
    }
  ...
  function mergeAndSync(willEnter, willLeave, didLeave, oldMergedPropsStyles, destStyles, oldCurrentStyles, oldCurrentVelocities, oldLastIdealStyles, oldLastIdealVelocities) {
    var newMergedPropsStyles = mergeDiff(oldMergedPropsStyles, destStyles, function (oldIndex, oldMergedPropsStyle) {
          ...
          for (var i = 0; i < newMergedPropsStyles.length; i++) {
            ...
            for (var key in newMergedPropsStyle) {
              ...
              if (typeof styleValue === 'number') {
                ...
                var _stepper2 = stepper(msPerFrame / 1000, newLastIdealStyleValue, newLastIdealVelocityValue, styleValue.val, styleValue.stiffness, styleValue.damping, styleValue.precision),
                    nextIdealX = _stepper2[0],
                    nextIdealV = _stepper2[1];
